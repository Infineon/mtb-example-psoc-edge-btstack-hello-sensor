...
The following example clones the "[Bluetooth&reg; LE hello sensor](https://github.com/Infineon/mtb-example-psoc-edge-btstack-hello-sensor)" application with the desired name "BluetoothHelloSensor" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-btstack-hello-sensor --user-app-name BluetoothHelloSensor --target-dir "C:/mtb_projects"
   ```
